...
export default function SellerNotificationsScreen() {
  ...
  const renderNotificationItem = ({ item }: { item: Notification }) => (
    ...
    >
      <View style={[styles.notificationIconContainer, { backgroundColor: getNotificationColor(item.type) + '10' }]}>
        <Ionicons
      ...
      <View style={styles.notificationContent}>
        <Text style={styles.notificationTitle}>{item.title || getNotificationTitle(item.type)}</Text>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>
              When customers place orders, you'll see them here
            </Text>
          </View>
        }
      />
